<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageStuForm.aspx.cs" Inherits="Defence.aspx.ManagerStuForm"  %>
...
&nbsp;<asp:TextBox ID="m_searchTextBox"  runat="server"></asp:TextBox>
        ...
        &nbsp;&nbsp;
            <asp:Button ID="m_importButton" runat="server" OnClick="m_importButton_Click" Text="导入学生表格" />
            &nbsp;
...
&nbsp;
        ...
        <div style="position:absolute; top: 279px; left: 804px; width: 417px;">
            <asp:Button ID="m_exportButton" runat="server" OnClick="m_exportButton_Click" Text="导出学生表格" />
            </div>

        

        <asp:GridView ID="m_stuGridView" runat="server" CssClass="t2" style="position:absolute; top: 338px; left: 377px; width: 783px;" AllowPaging="True" OnPageIndexChanging="OnPageChange" AutoGenerateColumns="False" OnRowCancelingEdit="OnRowCanel" OnRowEditing="OnRowEditing" PageSize="12" OnRowUpdating="OnRowUpdating" OnRowDeleting="OnRowDeleting" OnRowDataBound="OnRowDataBound">
